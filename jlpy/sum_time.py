...
""".format(n)
    ...
    print(timeit.timeit(sum_by_sum_func, list_setup, number=loops))
...
""".format(n)
    ...
    print(timeit.timeit(sum_by_sum_func, array_setup, number=loops))
...
""".format(n)
    ...
    print(timeit.timeit(sum_by_sum_func, numpy_setup, number=loops))
